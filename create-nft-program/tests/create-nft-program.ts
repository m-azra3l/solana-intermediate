...
import { CreateNftProgram } from "../target/types/create_nft_program";import { Connection, PublicKey, LAMPORTS_PER_SOL, Keypair, SystemProgram, SYSVAR_RENT_PUBKEY } from '@solana/web3.js'
...
describe("create-nft-program", async () => {
